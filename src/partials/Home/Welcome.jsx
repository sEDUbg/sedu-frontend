        ...
        <section className="relative">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="text-center pb-12 md:pb-16">
                    ...
                    <div className="max-w-xs mx-auto sm:max-w-none flex sm:flex-row flex-col justify-center sm:space-x-4 sm:space-y-0 space-y-4" data-aos="zoom-y-out" data-aos-delay="300">
                        <a className="px-5 py-4 rounded-md dark:text-white dark:bg-slate-800 dark:hover:bg-slate-700 border border-gray-200 dark:border-slate-700" href="#plans">вижте плановете</a>
                        <a className="px-5 py-4 rounded-md dark:text-white dark:bg-slate-900 dark:hover:bg-slate-800 border border-gray-200 dark:border-slate-800" href="#0">научете повече</a>
                    </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col justify-center rounded-xl aspect-video w-screen sm:w-3/4">
                        <iframe className="rounded-xl aspect-video w-full" src="https://www.youtube.com/embed/mwL1noMFx-E" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" fs="0" modestbranding="1"></iframe>
                    </div>
