  ...
  const features = [
    {
      ...
      description:
        "sedubg is a platform for students to share their knowledge with other students. It is easy to use and easy to learn.",
      icon: <FontAwesome.FaUserFriends />,
    },
    {
      title: "споделяне на материали",
      description:
        "sedubg is free to use. You can use it for free. You can use it for free. You can use it for free.",
      icon: <FontAwesome.FaShare />,
    },
    {
      title: "оценяване на материали",
      description:
        "sedubg is open source. You can use it for free. You can use it for free. You can use it for free.",
