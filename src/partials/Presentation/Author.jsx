        ...
        <div className="presentation__author bg-gray-100 dark:bg-slate-900 rounded-2xl p-5 dark:text-white divide-y dark:divide-slate-800 space-y-4 border dark:border-slate-800">
            <div className='flex space-x-4'>
                ...
                <div className="flex-initial presentation__author-info space-y-4">
                    <div>
                        <div className="presentation__author-name font-black text-lg"><h3>{presentation?.author.name}</h3></div>
                        <div className="presentation__author-class font-light text-xs">ученик в {presentation?.author.class} клас, {presentation?.author.school}</div>
                    </div>
                    <div className="presentation__author-bio text-sm">{presentation?.author.bio}</div>
                </div>
            </div>
            <div className="divide-y space-y-4 dark:divide-slate-800">
                ...
                <div className="specs pt-4">
                    ...
                    <div className="flex items-center space-x-2"><FontAwesome.FaRegFilePowerpoint /><p>{presentation?.info.specs.type}</p></div>
                </div>
                <div className="stats flex space-x-4 pt-4">
                    ...
                    <div className="flex items-center space-x-2"><FontAwesome.FaRegThumbsUp /> <p>{presentation?.info.stats.likes}</p></div>
